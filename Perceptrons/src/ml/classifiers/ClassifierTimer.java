...
public class ClassifierTimer {
	...
	public static void main(String[] args){
		...
		*/
		...
		PerceptronClassifier original = new PerceptronClassifier(dataset.getAllFeatureIndices());
		timeClassifier(original, dataset, numRuns);
		
		System.out.println("------------------------");
		System.out.println("Weighted Perceptron:");
		WeightedPerceptronClassifier weighted = new WeightedPerceptronClassifier(dataset.getAllFeatureIndices());
